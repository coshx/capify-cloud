class Autoscale
  ...
  #todo
  #   set_capacity_to_four/set_capacity_to_one to change scaling capacity manually
  #   def min_instances ; 0 end # @config_params[:min_instances] || 1 end
  #   def max_instances ; 10 end #@config_params[:max_instances] || 5 end
  ...
  def set_capacity_to_four
    @connection.update_auto_scaling_group(autoscale_group_name,{"LaunchConfigurationName" => 'sandbox_launchconfig_ami-252ba94c', "MinSize" => min_instances, "MaxSize" => 10})
    @connection.put_scaling_policy('ExactCapacity', autoscale_group_name, 'ScaleTo4', 4, {})
    @connection.execute_policy("ScaleTo4",'AutoScalingGroupName' => autoscale_group_name)
  end
  def set_capacity_to_one
    @connection.put_scaling_policy('ExactCapacity', autoscale_group_name, 'RemoveAllPolicy', 1, {})
    @connection.execute_policy("RemoveAllPolicy",'AutoScalingGroupName' => autoscale_group_name)
  end
